 ...
 */
package com.pablojoseoroz.navigation

import android.content.Context
import android.os.Bundle
import android.content.res.TypedArray
import android.util.AttributeSet
import com.pablojoseoroz.navigation.R
...
class NavHostFragment : Fragment(), NavHost {
    ...
    override fun getNavController(): NavController {
        ...
        return mNavController as NavHostController
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mNavController!!.enableOnBackPressed(
            mIsPrimaryBeforeOnCreate != null && mIsPrimaryBeforeOnCreate as Boolean
        )
        ...
        fun findNavController(fragment: Fragment): NavController {
            ...
            while (findFragment != null) {
                ...
                val primaryNavFragment =
                    findFragment.parentFragmentManager //requireFragmentManager()
